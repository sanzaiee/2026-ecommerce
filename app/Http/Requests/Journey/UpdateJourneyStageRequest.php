...
class UpdateJourneyStageRequest extends FormRequest
{
    ...
    public function toDto(): UpdateJourneyStageData
    {
        return new UpdateJourneyStageData(
            id: (int) $this->route('journey_stage'),
