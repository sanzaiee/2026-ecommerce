...
readonly class UpdateSiteSettingsData
{
    public function __construct(
        ...
        public ?string $adminColorPrimary = null,
        public ?string $adminColorSecondary = null,
        public ?string $adminColorNeutral = null,
    ...
    public function toArray(): array
    {
        $data = array_filter([
            ...
            'admin_color_primary' => $this->adminColorPrimary,
            'admin_color_secondary' => $this->adminColorSecondary,
            'admin_color_neutral' => $this->adminColorNeutral,
