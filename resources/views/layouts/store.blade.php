...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400&family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,400&family=Open+Sans:ital,wght@0,400;0,500;0,600;0,700;0,800;1,400&display=swap"
        rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('js/store-search.js') }}?v={{ filemtime(public_path('js/store-search.js')) ?: 1 }}" defer>
    </script>
    @stack('scripts')
</body>
