    ...
    <div class="mobile-nav-drawer__inner">
        ...
        <div class="mobile-nav-drawer__body">
            ...
            <div class="mobile-nav-drawer__actions">
                ...
                @guest
                    <a href="{{ route('login') }}" class="mobile-nav-drawer__action">
                        <i class="bi bi-person" aria-hidden="true"></i>
                        <span>Sign in</span>
                    </a>
                @else
                    @if (auth()->user()->isCustomer())
                        <a href="{{ route('account') }}" class="mobile-nav-drawer__action">
                ...
                <a href="#" class="mobile-nav-drawer__action mobile-nav-drawer__action--cart"
                    aria-label="Open cart" data-drawer-open="cart" role="button">
