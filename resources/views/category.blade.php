...
@section('title', $category->name . ' — Mandira Foods')
...
@section('content')
    <main class="shop-page" id="categoryPage">
        ...
        <section class="category-hero" aria-labelledby="categoryHeroTitle">
            @if ($category->hasImage())
                <div class="category-hero__media" aria-hidden="true">
                    <img src="{{ $category->imageUrl('medium') }}" alt="" loading="eager" decoding="async">
                </div>
            @endif
            ...
            <div class="container category-hero__inner">
                ...
                <h1 class="category-hero__title" id="categoryHeroTitle">{{ $category->name }}</h1>
                ...
                <div class="col-lg-9 shop-layout__main">
                    <div class="shop-toolbar category-toolbar">
                        <div class="shop-toolbar__start">
                            <label for="categorySearch" class="visually-hidden">Search in {{ $category->name }}</label>
                            <div class="category-toolbar__search">
                                <i class="bi bi-search" aria-hidden="true"></i>
                                <input type="search" id="categorySearch" class="category-toolbar__search-input"
                                    placeholder="Search in this category…" data-category-search autocomplete="off">
                            </div>
                        </div>
