...
@push('styles')
    <style>
        ...
        .settings-tabs .nav-link.active { color: #1a1a1a; border-color: #dee2e6 #dee2e6 #fff; }
        .media-preview-box { max-width: 160px; border-radius: 8px; border: 1px solid #dee2e6; }
        .favicon-preview { width: 32px; height: 32px; object-fit: contain; }
        .theme-color-row { align-items: end; }
        .theme-color-picker { width: 3rem; height: 2.5rem; padding: 0.2rem; cursor: pointer; }
        .theme-preview {
        ...
        <ul class="nav nav-tabs settings-tabs mb-4" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-legal" data-bs-toggle="tab" data-bs-target="#pane-legal"
                    type="button" role="tab">Legal Pages</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tab-seo" data-bs-toggle="tab" data-bs-target="#pane-seo"
                    type="button" role="tab">SEO Defaults</button>
            </li>
        </ul>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="pane-general" role="tabpanel">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-text">Top strip, left side. Leave empty to hide the strip if secondary is also empty.</div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-text">HTML allowed for &copy; symbol, e.g. <code>&amp;copy; 2026 Mandira Foods</code></div>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Logo</label>
                        <input type="file" name="logo" class="form-control" accept="image/*">
                        @if ($settings->getFirstMediaUrl('logo'))
                            <img src="{{ $settings->getFirstMediaUrl('logo') }}" alt="Logo" class="media-preview-box mt-2">
                        @endif
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Favicon</label>
                        <input type="file" name="favicon" class="form-control" accept="image/png,image/x-icon,image/vnd.microsoft.icon,image/jpeg,image/webp">
                        @if ($settings->getFirstMediaUrl('favicon'))
                            <img src="{{ $settings->getFirstMediaUrl('favicon') }}" alt="Favicon" class="favicon-preview mt-2">
                        @endif
            ...
            <div class="tab-pane fade" id="pane-appearance" role="tabpanel">
                <p class="text-muted small mb-3">
                    Controls storefront buttons, links, header strip, and hero accents. Changes apply after you save (cached for up to 1 hour).
                </p>
                <div class="row g-4">
                    <div class="col-lg-7">
                        @foreach ([
                            ...
                            <div class="row g-2 theme-color-row mb-3" data-theme-field="{{ $field }}">
                                ...
                                <div class="col">
                                    <input type="text" name="{{ $field }}" class="form-control font-monospace"
                                        value="{{ $meta['value'] }}" maxlength="7" pattern="^#[0-9A-Fa-f]{6}$"
                                        placeholder="#b91c1c" data-theme-hex="{{ $field }}">
                                    @error($field)
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="theme-preview" id="themePreview">
                            <div class="theme-preview__strip" id="previewStrip">Free shipping on orders above Rs. 2,000</div>
                            <button type="button" class="theme-preview__btn" id="previewBtn">Add to cart</button>
                            <a href="#" class="theme-preview__link" id="previewLink" onclick="return false;">View details</a>
            ...
            <div class="tab-pane fade" id="pane-legal" role="tabpanel">
                <p class="text-muted small mb-3">
                    Content appears on the public policy pages. Saving updates the &ldquo;Last updated&rdquo; date automatically.
                </p>
                <div class="mb-4">
                    <label class="form-label d-flex justify-content-between">
                        <span>Privacy Policy</span>
                        @if ($settings->privacy_updated_at)
                            <span class="text-muted small">Last updated: {{ $settings->privacy_updated_at->format('M j, Y') }}</span>
                        @endif
                    </label>
                ...
                <div class="mb-4">
                    <label class="form-label d-flex justify-content-between">
                        ...
                        @if ($settings->terms_updated_at)
                            <span class="text-muted small">Last updated: {{ $settings->terms_updated_at->format('M j, Y') }}</span>
                        @endif
                    </label>
                ...
                <div class="mb-4">
                    <label class="form-label d-flex justify-content-between">
                        ...
                        @if ($settings->refund_updated_at)
                            <span class="text-muted small">Last updated: {{ $settings->refund_updated_at->format('M j, Y') }}</span>
                        @endif
                    </label>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        ...
                        <input type="text" name="default_meta_title" class="form-control"
                            ...
                            placeholder="Mandira Foods — Premium Dried Fruits & Pickles">
                    </div>
                    <div class="col-12">
        ...
        (function () {
            ...
            function updatePreview() {
                ...
                if (btn) {
                    ...
                    btn.onmouseenter = () => { btn.style.background = primaryDark; };
